...
const PropertyItem = ({ name, thumbnail, description }) => {
  return (
    <div className="property-item">
      <img src={thumbnail} alt={description} className="property-item__img" />
      <div className="property-item__info">
        <div className="property-item__info__left-section">
          ...
          <h6 className="property-item__info__left-section__description">{description}</h6>
        </div>
